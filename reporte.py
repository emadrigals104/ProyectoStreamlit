...
def reporte():
    ...
    st.markdown('''
                <iframe title="Reporte Power BI - Abandono de Clientes" width="1100" height="673.5" src="https://app.powerbi.com/view?r=eyJrIjoiYzJkOWRiYzctMDE4NS00NTcyLTkwMGYtMDQ0NzkwMTZiZmVmIiwidCI6ImQyZGZkYjc0LWZiNDItNGMzYi04ZGFkLTZiNzg1NzlmMmM4ZCIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
